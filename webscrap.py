...
try:
	...
	if res.title is None:
		...
		print("Title")		#prints the content within <title> tags
		print(res.title)		#prints the content within <title> tags
		#print("Tag Name")		#prints the content within <title> tags
		#print(res.title.name)		#prints the content within <title> tags
		#print("Tag String")		#prints the content within <title> tags
		#print(res.title.string)		#prints the content within <title> tags
		#print("Tag Parent")		#prints the content within <title> tags
		#print(res.title.parent.name)		#prints the content within <title> tags
